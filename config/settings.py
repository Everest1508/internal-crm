...
# EMAIL_HOST = 'smtp.outlook.com'  # Outlook/Hotmail SMTP
# EMAIL_HOST = 'smtp.yahoo.com'   # Yahoo SMTP
# EMAIL_HOST = 'smtp.zoho.com'    # Zoho SMTP
# EMAIL_HOST = 'smtp.sendgrid.net' # SendGrid SMTP
# EMAIL_HOST = 'smtp.mailgun.org'  # Mailgun SMTP

# EMAIL_PORT = 587  # TLS port (recommended)
# EMAIL_PORT = 465  # SSL port
# EMAIL_PORT = 25   # Standard port (not recommended)

# EMAIL_USE_TLS = True   # Use TLS encryption
# EMAIL_USE_SSL = False  # Don't use SSL (use TLS instead)
...
# Email File Path (for development - saves emails as files)
